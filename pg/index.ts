...
pool
  ...
  .then(() => pool.query<Product>(`UPDATE product SET description = v.description FROM (VALUES ($1::INTEGER, $2), ($3::INTEGER, $4)) AS v (id, description) WHERE v.id = product.id RETURNING product.*`, [1, "C", 2, "D"]))
